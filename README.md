...
I am currently preparing my application for a Ph.D. program with the following objectives:

- Achieving an **IELTS overall band score of 6.5** (English is not my native language, so this requires dedicated effort)
- Expanding my research on **metaheuristic algorithms for complex problem-solving**, building upon my master's thesis
